...
<body>
    <form id="form1" runat="server">
        ...
        <div class="section">
            ...
            <br/><br />            
            <asp:UpdatePanel runat="server" ID="BooksByCategoryUpdatePanel" UpdateMode="Conditional">
                <ContentTemplate>
        ...
        <div class="section">
            <asp:UpdatePanel runat="server" ID="BookViewUpdatePanel" UpdateMode="Conditional">
                <ContentTemplate>
                        ...
                        <ItemTemplate>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:CheckBox runat="server" ID="NewViewCB" Checked='<%#Eval("New") %>' Enabled="false" /></td>
                                </tr>
                                <tr>
                        ...
                        <EditItemTemplate>
                            <table>
                                <tr>
                                    <td class="label">Id</td>
                                    <td>
                                        <asp:Label ID="id" runat="server" Text='<%#Bind("N") %>' /></td>
                                </tr>
                                <tr>
                                    <td class="label">Название</td>
                                    <td>
                                        <asp:TextBox runat="server" ID="EditName" TextMode="MultiLine" Text='<%#Bind("Name") %>' /></td>
                                </tr>
                                <tr>
                                    <td class="label">Новая</td>
                                    <td>
                                        <asp:CheckBox runat="server" ID="NewEditCB" Checked='<%#Bind("New") %>' /></td>
                                </tr>
                                <tr>
                                    <td class="label">Код</td>
                                    <td>
                                        <asp:TextBox runat="server" ID="EditCode" Text='<%#Bind("Code") %>' /></td>
                                </tr>
                                <tr>
                                    <td class="label">Цена</td>
                                    <td>
                                        <asp:TextBox runat="server" ID="EditPrice" Text='<%#Bind("Price") %>' /></td>
                                </tr>
                                <tr>
                                    <td class="label">Страниц</td>
                                    <td>
                                        <asp:TextBox runat="server" ID="EditPages" TextMode="Number" Text='<%#Bind("Pages") %>' /></td>
                                </tr>
                                <tr>
                                    <td class="label">Дата выхода</td>
                                    <td>
                                        <asp:Calendar ID="EditDate" runat="server" SelectedDate='<%#Bind("Date")%>' VisibleDate='<%#(Eval("Date")==null)?DateTime.Today:Eval("Date") %>' />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="label">Тираж</td>
                                    <td>
                                        <asp:TextBox runat="server" ID="EditPressrun" TextMode="Number" Text='<%#Bind("Pressrun") %>' /></td>
                                </tr>
                                <tr>
                                    <td class="label">Формат</td>
                                    <td>
                                        <asp:DropDownList ID="SelectFormat" runat="server" DataSourceID="Format" DataTextField="Format" DataValueField="id" SelectedValue='<%#Bind("format_id") %>' /></td>
                                </tr>
                                <tr>
                                    <td class="label">Издательство</td>
                                    <td>
                                        <asp:DropDownList ID="SelectIzd" runat="server" DataSourceID="Izd" DataTextField="Izd" DataValueField="id" SelectedValue='<%#Bind("izd_id") %>' /></td>
                                </tr>
                                <tr>
                                    <td class="label">Категория</td>
                                    <td>
                                        <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="Category" DataTextField="Category" DataValueField="id" SelectedValue='<%#Bind("kategory_id") %>' /></td>
                                </tr>
                                <tr>
                                    <td class="label">Тема</td>
                                    <td>
                                        <asp:DropDownList ID="SelectTheme" runat="server" DataSourceID="Theme" DataTextField="Themes" DataValueField="id" SelectedValue='<%#Bind("themes_id") %>' /></td>
                                </tr>
                            </table>
                        ...
                        <InsertItemTemplate>
                            <table>
                                <tr>
                                    <td class="label">Id</td>
                                    <td>
                                        <asp:Label ID="idInsert" runat="server" Text='<%#Bind("N") %>' /></td>
                                </tr>
                                <tr>
                                    <td class="label">Название</td>
                                    <td>
                ...
                <Triggers>
                    <asp:AsyncPostBackTrigger ControlID="BooksByCategory" EventName="SelectedIndexChanged" />
                </Triggers>
            </asp:UpdatePanel>
        </div>
